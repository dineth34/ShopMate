...
//        adapter.notifyDataSetChanged();
        ...
        try {
            searchService = SearchServiceFactory.create(SiteKitVIew.this, URLEncoder.encode("CgB6e3x9CTy5Qd7KJ6hO09la99w1eKuwzsCoVOQK9sm4vkINHK6aRBBg0cFHxNyKqc5ihx5Txdz/8AhLCoFwwqFI", "UTF-8") );
...
//                        adapter.notifyDataSetChanged();
                    ...
                    @Override
                    public void onSearchError(@org.jetbrains.annotations.NotNull SearchStatus status) {
                        Toast.makeText(SiteKitVIew.this,""+status.getErrorMessage()+":"+status.getErrorMessage(), Toast.LENGTH_LONG).show();
                        spinner.setVisibility(View.GONE);
                        Log.i("TAGSITE", "Error : " + status.getErrorCode() + " " + status.getErrorMessage());
                    }
                };
